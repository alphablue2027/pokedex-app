...
- Tipos compartidos (`PokemonSummary`, `PokemonListResponse`) viven en `src/helpers/load.ts` — es el archivo dueño de esa forma de datos (la respuesta de la PokeAPI). Nada de carpeta `types/` de primer nivel (prohibido por convención general).
